...
if (process.client){
  ...
  currentToken = await getToken(messaging, { vapidKey: env.FCM.vapidKey }).catch(e=>{
    pitLib.swal("Please provide notification permission for better performance","warning","top-right",1500)
  })
}
  ...
  <div class="main-wrap">
    ...
    <div class="nav-header bg-transparent shadow-none border-0">
      <div class="nav-top w-100">
        ...
        <NuxtLink to="/login" class="header-btn d-none d-lg-block bg-dark fw-500 text-white font-xsss p-3 ms-auto w100 text-center lh-20 rounded-xl"  data-bs-toggle="modal" data-bs-target="#Modallogin">Login</NuxtLink>
        <NuxtLink to="/signup" class="header-btn d-none d-lg-block bg-primary fw-500 text-white font-xsss p-3 ms-2 w100 text-center lh-20 rounded-xl"  data-bs-toggle="modal" data-bs-target="#Modalregister">Register</NuxtLink>
      </div>
    ...
    <div class="row">
      <div class="col-xl-5 d-none d-xl-block p-0 vh-100 bg-image-cover bg-no-repeat" style="background-image: url(/tpl1/images/login-bg.jpg);"></div>
