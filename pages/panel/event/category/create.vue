...
function submit() {
  ...
  $fetch(endpoints.event.category.create,{
...
<template>
  <PanelHeader title="Event Categories" description="Create and list enent categories. Users will choose one of them." icon="calendar-days"></PanelHeader>
