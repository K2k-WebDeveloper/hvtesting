...
function submit() {
  ...
  $fetch(endpoints.recipe.category.create,{
...
<template>
  <PanelHeader title="Recipe Categories" description="Create and list recipe categories. Users will choose one of them." icon="recipe"></PanelHeader>
