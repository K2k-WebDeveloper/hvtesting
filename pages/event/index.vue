          ...
          <div class="col-xl-8 col-xxl-9 col-lg-8">
            <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
              <div class="card-body p-0">
                <NuxtLink to="/event/create" class=" font-xssss fw-600 text-grey-500 card-body p-0 d-flex align-items-center"><i class="btn-round-sm font-xs text-primary fa-solid fa-plus me-2 bg-greylight"></i>
                  Add New Event
                </NuxtLink>
              </div>
            ...
            <div v-for="v in events" class="card data-card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
              ...
              <div class="card-body d-flex p-0">
                ...
                <SharerCard :title="v.title" :url="pitLib.util.url('event/'+v.slug)"></SharerCard>
              </div>
